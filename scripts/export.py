...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python script.py <input_checkpoint_path> <output_file_path>")
        sys.exit(1)
        
    input_path = sys.argv[1]
    output_path = sys.argv[2]
        
    exported_file = export_pretrained_compression_model(input_path, output_path)
    print(f"Exported data to: {exported_file}")